...
export const FONTS = {
    ...
    h1: { fontFamily: "Roboto-Black", fontSize: SIZES.h1, lineHeight: 36,fontWeight:'900' },
    h2: { fontFamily: "Roboto-Bold", fontSize: SIZES.h2, lineHeight: 30,fontWeight:'800' },
    h3: { fontFamily: "Roboto-Bold", fontSize: SIZES.h3, lineHeight: 22,fontWeight:'700' },
